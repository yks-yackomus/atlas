...
export default {
  ...
  header: `<a target="_self" href="https://yackomus.com" style="text-decoration:none" >Yackomus</a><a>✦ ATLAS</a>`, // what to show in the header (HTML)
  footer: `<div style="display: flex; flex-direction: row; align-items: center;justify-content: center;">
    <p>Copyright © 2025 Thiago Oliveira</p>
